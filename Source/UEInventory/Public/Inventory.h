...
protected:
    ...
    void ShiftItems(uint64 StartIndex, uint64 EndIndex, EDirection Direction, bool bUpdateUI = true);
    ...
    static float CustomEaseInOut(float T);
    ...
    // Added to support multi-item sliding
    UPROPERTY()
